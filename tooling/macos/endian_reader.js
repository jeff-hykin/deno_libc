...
Reader.prototype.readUInt8 = function readUInt8(buf, offset) {
    buf = new Buffer(buf) // to handle if Uint8Array or similar was passed
...
Reader.prototype.readUInt16 = function readUInt16(buf, offset) {
    buf = new Buffer(buf) // to handle if Uint8Array or similar was passed
    if (this.endian === "le") return buf.readUInt16LE(offset)
    else return buf.readUInt16BE(offset)
}

Reader.prototype.readInt16 = function readInt16(buf, offset) {
    buf = new Buffer(buf) // to handle if Uint8Array or similar was passed
    if (this.endian === "le") return buf.readInt16LE(offset)
    else return buf.readInt16BE(offset)
}

Reader.prototype.readUInt32 = function readUInt32(buf, offset) {
    buf = new Buffer(buf) // to handle if Uint8Array or similar was passed
    if (this.endian === "le") return buf.readUInt32LE(offset)
    else return buf.readUInt32BE(offset)
}

Reader.prototype.readInt32 = function readInt32(buf, offset) {
    buf = new Buffer(buf) // to handle if Uint8Array or similar was passed
    if (this.endian === "le") return buf.readInt32LE(offset)
    else return buf.readInt32BE(offset)
}
...
Reader.prototype.readUInt64 = function readUInt64(buf, offset) {
    ...
    if (this.endian === "le") return a + b * 0x100000000
    else return b + a * 0x100000000
}
